...
import com.youtube_tools.model.Video;
...
return videoIds;
    ...
    public VideoDetails getVideoDetails(String videoId){
        VideoDetailsResponse response = webClientBuilder.baseUrl(baseUrl)
            .build()
            .get()
            .uri(uriBuilder -> uriBuilder
                    .path("/videos")
    ...
    .id(videoId)
    .title(snippet.title)
    .description(snippet.description)  // ✅ ADD
    .channelTitle(snippet.channelTitle)
    .publishedAt(snippet.publishedAt)  // ✅ ADD
    .thumbnailUrl(snippet.thumbnails.getBestThumbnailUrl()) // ✅ ADD
...
static class VideoDetailsResponse {
    List<VideoDetailsItem> items;
}

@Data
static class VideoDetailsItem {
    String id;   
    Snippet snippet;
} 
    @Data
    ...
    @Data
     ...
     public int getMaxRelatedVideos() {
         return maxRelatedVideos;
     }
     public void setMaxRelatedVideos(int maxRelatedVideos) {
